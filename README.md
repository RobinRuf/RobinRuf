...
🚀 **Started Coding - 2012**\
In 2012, my friends and I decided to create a browser game, kicking off my coding journey. Our toolkit? HTML5, CSS3, JavaScript, PHP, C#, and SQL. It was the beginning of a journey that I didn't know would shape my career and passion for the years to come.

📱 **Stepping into Web and Mobile Dev**\
I soon moved into web and mobile development. Swift and Kotlin became my go-to languages as I explored the realms of mobile development.

💻 **2021 - Falling for React.JS**\
By 2021, I found the React.JS library and fell in love with web development all over again. I even switched to React Native for mobile projects.

🌐 **2022 - Next.JS Enters the Scene**\
The Next.JS Framework caught my attention in 2022. This framework showed me a simpler way to build web apps, and I've been a fan ever since, using it for the most of my own and freelance projects.
...
<img align="left" alt="next" width="60px" style="padding-right:10px;" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original-wordmark.svg" />
...
<img align="left" alt="appwrite" width="60px" style="padding-right:10px;" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/appwrite/appwrite-original.svg" />
